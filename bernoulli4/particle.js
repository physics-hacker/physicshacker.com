...
function Particle(x, y, r) {
  ...
  this.body.SetLinearVelocity(new box2d.b2Vec2(10, random(-5,5)));
  ...
  this.done = function() {
	...
	this.body.SetTransformXYRadians(0, random(0.4*height,0.6*height)/scaleFactor, 0);
      this.body.SetLinearVelocity(new box2d.b2Vec2(20, random(-2,2)));
      return false;
    }

    if (pos.x < 0) {
	//      this.body.SetTransformXYRadians(width/scaleFactor, pos.y/scaleFactor, 0);
	this.body.SetTransformXYRadians(width/scaleFactor, random(0.4*height,0.6*height)/scaleFactor, 0);
      return false;
    }
